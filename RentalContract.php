<?php
	...
	if (empty($reservationNumber)) {
		...
		$query = "SELECT 
							    ...
							    res.StartDate,
							    res.EndDate,
							    pClk.FirstName AS clkFirstName,
							    pClk.LastName AS clkLastName,
							...
							FROM
							    reservation AS res
							        INNER JOIN
							    clerk AS pClk ON res.PickupClerkLogin = pClk.Login
							        INNER JOIN
...
<head>
    ...
    <b><label class="rental_contract_label">Estimated Rental:</label></b>
		<?php echo "$" . number_format($TotalRentalPrice, 2) ?>
    <br>
    <br>

    <b><label class="rental_contract_label">Signature: ____________________________________</label></b>
		<br>
		<br>
